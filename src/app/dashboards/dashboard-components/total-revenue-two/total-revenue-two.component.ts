...
export type totalrevenuetwoChartOptions = {
...
@Component({
  selector: 'app-total-revenue-two',
  standalone: true,
  imports: [NgApexchartsModule],
  templateUrl: './total-revenue-two.component.html',
})
export class TotalRevenueTwoComponent implements OnInit {
  @ViewChild('chart') chart: ChartComponent = Object.create(null);
  public totalrevenuetwoChartOptions: Partial<totalrevenuetwoChartOptions>;
  constructor() {
    this.totalrevenuetwoChartOptions = {

      series: [
        { name: "2023", data: [65, 80, 80, 60, 60, 45, 45, 80, 80, 70, 70, 90, 90, 80, 80, 80, 60, 60, 50] },
        { name: "2024", data: [90, 110, 110, 95, 95, 85, 85, 95, 95, 115, 115, 100, 100, 115, 115, 95, 95, 85, 85] },
      ],
      chart: { fontFamily: "inherit", type: "area", height: 225, toolbar: { show: !1 } },
      plotOptions: {},
      legend: { show: !1 },
